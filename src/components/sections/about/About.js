  ...
  const aboutMarkup = () => {
    ...
    return (
      <Typography variant="body1" className={classes.textShadowWhite}>
        <p>
          I am a graduate of the Management Science program at {ucsd}, a quantitative major in applied economics with a strong focus on statistical analysis and mathematics. During my time there, I used MatLab to solve constraint problems. This was my introduction to 'for loops' and the ability to systematically program a computer to make decisions. I was fascinated. I began adding computer science courses to my curriculum. I studied topics ranging from object-oriented programming to lower level programming with Assembly.
        </p>
        <p>
          Since graduating, I have held multiple roles building data driven products. Visit my {linkedin} profile to see what my peers have to say about me!
        </p>
        <p>
          In addition to the experience I have gained in my professional roles, I have continued my education by building projects and utilizing resources such as Udemy, Youtube, and many others.
        </p>
        <p>
          I am passionate about web applications, but more specifically, building the complex data infrastructures that power today's modern web applications. I am excited to continue growing and contributing to this field.
        </p>
      </Typography>
    );
  };
